...
<h2><?php echo $mission['Battle']['type'] . ' ' . $mission['Battle']['num']; ?></h2>
	<dl>
		...
		<dt><?php echo __('tsaunders'); ?></dt>
		<dd>
			<?php echo "http://tsaunders.net/pyrite/missions/score/" . $mission['Mission']['id']; ?>
			&nbsp;
		</dd>
		...
		<dt><?php echo __('Potential Score'); ?></dt>
		<dd>
			<?php echo h($mission['Mission']['potentialscore']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Potential Achieved'); ?></dt>
		<dd>
			<?php echo h(round($mission['Mission']['hs_total'] / $mission['Mission']['potentialscore'] * 100, 2)) . '%'; ?>
			&nbsp;
		</dd>
		...
		<dt><?php echo __('Player Craft'); ?></dt>
		<dd>
...
<!--		</dd>-->
        ...
        <dd>
            <?php if ($next) echo $this->Html->Link('Next', array('action' => 'score', $next)); ?>
            &nbsp;
        </dd>
		<dt><?php echo __('Medium'); ?></dt>
		<dd>
			<?php echo $this->Html->Link('Medium', array('action' => 'medium', $mission['Mission']['id'])); ?>
			&nbsp;
		</dd>
	</dl>
    <pre>
