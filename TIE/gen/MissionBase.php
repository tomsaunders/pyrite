...
abstract class MissionBase extends PyriteBase implements Byteable {
	...
	protected function toHexString() {
		...
		$offset += $this->FlightGroups->getLength();
		...
		$offset += $this->Messages->getLength();
		...
		$offset += $this->GlobalGoals->getLength();
		...
		$offset += $this->PreMissionQuestions->getLength();
		...
		$offset += $this->PostMissionQuestions->getLength();
