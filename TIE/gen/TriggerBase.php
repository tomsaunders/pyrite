...
abstract class TriggerBase extends PyriteBase implements Byteable {
	...
	public function __debugInfo() {
        ...
        protected function getConditionLabel() {
            return isset($this->Condition) ? Constants::$CONDITION[$this->Condition] : 'Unknown';
        }


        protected function getVariableTypeLabel() {
            return isset($this->VariableType) ? Constants::$VARIABLETYPE[$this->VariableType] : 'Unknown';
        }


        protected function getTriggerAmountLabel() {
            return isset($this->TriggerAmount) ? Constants::$TRIGGERAMOUNT[$this->TriggerAmount] : 'Unknown';
        }
