...
abstract class PostMissionQuestionsBase extends PyriteBase implements Byteable {
	...
	protected $PostMissionQuestionsLength = 0;
	...
	public function __construct($hex){
		...
		$this->Question = $this->getChar($hex, $this->QuestionLength(), 0x4);
		$offset = 0x4;
		$offset += $this->QuestionLength();
		$this->Reserved = $this->getByte($hex, $offset);
		$offset += 1;
		$this->Answer = $this->getChar($hex, $this->AnswerLength(), $offset);
	...
	public function __debugInfo() {
        ...
        protected function getQuestionConditionLabel() {
            return isset($this->QuestionCondition) ? Constants::$QUESTIONCONDITION[$this->QuestionCondition] : 'Unknown';
        }


        protected function getQuestionTypeLabel() {
            return isset($this->QuestionType) ? Constants::$QUESTIONTYPE[$this->QuestionType] : 'Unknown';
        }
...
abstract protected function AnswerLength();
	...
	protected function toHexString() {
		...
		$offset = 0x4;
		$offset += $this->Question->getLength();
		$this->writeByte($hex, $this->Reserved, $offset);
		$offset += 1;
		$offset += $this->Reserved->getLength();
