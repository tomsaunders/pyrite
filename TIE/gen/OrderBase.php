...
abstract class OrderBase extends PyriteBase implements Byteable {
	...
	public function __debugInfo() {
        ...
        protected function getOrderLabel() {
            return isset($this->Order) ? Constants::$ORDER[$this->Order] : 'Unknown';
        }


        protected function getTarget3TypeLabel() {
            return isset($this->Target3Type) ? Constants::$VARIABLETYPE[$this->Target3Type] : 'Unknown';
        }


        protected function getTarget4TypeLabel() {
            return isset($this->Target4Type) ? Constants::$VARIABLETYPE[$this->Target4Type] : 'Unknown';
        }


        protected function getTarget1TypeLabel() {
            return isset($this->Target1Type) ? Constants::$VARIABLETYPE[$this->Target1Type] : 'Unknown';
        }


        protected function getTarget2TypeLabel() {
            return isset($this->Target2Type) ? Constants::$VARIABLETYPE[$this->Target2Type] : 'Unknown';
        }
